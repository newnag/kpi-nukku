    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white/80 backdrop-blur-sm shadow-2xl rounded-3xl p-8 border border-white/20 ">
            ...
            <div class="flex justify-center mb-6">
                <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full blur-lg opacity-30 animate-pulse"></div>
            ...
            <form id="loginForm" class="space-y-6" method="POST" action="{{ url('/login') }}">
                ...
                <button type="submit" id="submitBtn"
                    ...
                    <svg id="loading-spinner" class="hidden animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
