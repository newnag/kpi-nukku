            ...
            <div class="form-group-container">
                <x-card>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group ">
                            <x-input name="first_name" label="ชื่อจริง" placeholder="กรุณากรอกชื่อจริง" :required="true" />
                            @error('first_name')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group ">
                            <x-input name="last_name" label="นามสกุล" placeholder="กรุณากรอกนามสกุล" :required="true" />
                            @error('last_name')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group ">
                            <x-select name="department_id" label="หน่วยงาน" :options="$departments" option-value="id"
                                option-label="name" placeholder="กรุณาเลือกหน่วยงาน" :searchable="true" :required="true" />
                            @error('department_id')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <x-card>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group ">
                            <x-input name="password_confirmation" type="password" label="ยืนยันรหัสผ่าน"
                                placeholder="กรุณายืนยันรหัสผ่าน" :required="true" />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group ">
                            <x-select name="role" label="บทบาท (Role)" :options="collect($roles)->mapWithKeys(fn($r) => [$r => $r])->toArray()" placeholder="กรุณาเลือกบทบาท"
                                :required="true" />
                            @error('role')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
