...
class CriteriasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('criterias')->insert(array (
            ...
            array (
                'id' => 11,
            'name' => '1) อัตราส่วนจํานวนอาจารย์ประจําหรือพยาบาลวิชาชีพ ที่ทําหน้าที่สอนภาคปฏิบัติต่อนิสิต/นักศึกษาในการสอนแต่ละรายวิชาของภาคปฏิบัติ',
...
array (
'id' => 169,
'name' => '4.ดํารงตําแหน่งบริหารในสถาบันการศึกษาพยาบาล ไม่น้อยกว่า 2 ปี',
...
array (
'id' => 170,
'name' => '5.ผู้บริหารระดับรอง มีคุณสมบัติครบถ้วนตามข้อบังคับสภาการพยาบาลว่าด้วยหลักเกณฑ์การรับรองสถาบันฯ',
'description' => 'หลักฐานแสดงคุณสมบัติของผู้บริหารสูงสุดและผู้บริหารระดับรองในปีการศึกษาที่ปฏิบัติงานในช่วงเวลาของการประเมินเพื่อการรับรองสถาบัน',
'sequence' => 5,
'indicator_id' => 1,
'status' => 1,
...
array (
'id' => 168,
'name' => '3.มีประสบการณ์ด้านการสอนในสถาบันการศึกษาพยาบาลมาแล้วไม่น้อยกว่า 5 ปี',
'description' => 'หลักฐานแสดงคุณสมบัติของผู้บริหารสูงสุดและผู้บริหารระดับรองในปีการศึกษาที่ปฏิบัติงานในช่วงเวลาของการประเมินเพื่อการรับรองสถาบัน',
'sequence' => 3,
'indicator_id' => 1,
'status' => 1,
...
array (
'id' => 166,
'name' => '1.มีใบอนุญาตเป็นผู้ประกอบวิชาชีพการพยาบาลและการผดุงครรภ์ ชั้นหนึ่ง ที่เป็นปัจจุบัน และเป็นผู้ปฏิบัติงานประจําเต็มเวลาของสถาบันการศึกษานั้น',
'description' => 'หลักฐานแสดงคุณสมบัติของผู้บริหารสูงสุดและผู้บริหารระดับรองในปีการศึกษาที่ปฏิบัติงานในช่วงเวลาของการประเมินเพื่อการรับรองสถาบัน',
'sequence' => 1,
'indicator_id' => 1,
'status' => 1,
...
array (
'id' => 167,
'name' => '2.วุฒิการศึกษาไม่ต่ํากว่าปริญญาโททางการพยาบาล วิทยาศาสตร์สุขภาพ การบริหาร การศึกษา หรือมีตําแหน่งทางวิชาการไม่ต่ํากว่ารองศาสตราจารย์สาขาพยาบาลศาสตร์',
'description' => 'หลักฐานแสดงคุณสมบัติของผู้บริหารสูงสุดและผู้บริหารระดับรองในปีการศึกษาที่ปฏิบัติงานในช่วงเวลาของการประเมินเพื่อการรับรองสถาบัน',
'sequence' => 2,
'indicator_id' => 1,
'status' => 1,
